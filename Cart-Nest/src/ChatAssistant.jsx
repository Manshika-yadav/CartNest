...
function ChatAssistant({ products, addToCart }) {
  ...
  const getBotResponse = (userInput) => {
    ...
    if (lowerInput.includes("how are you")) {
      return { text: "I'm doing great! Thanks for asking 😊 How about you?" };
    }
    ...
    return { text: "I'm here to help! You can ask for product suggestions or say hi 😊" };
  };
  ...
  const handleSend = () => {
    ...
    setMessages((prev) => [...prev, userMsg, { sender: "bot", ...botMsg }]);
    setInput("");
  };
